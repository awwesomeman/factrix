...
def spanning_alpha(
    ...
    return MetricOutput(
        ...
        metadata={
            ...
            "base_factors": list(base_arrays.keys()),
        },
    )
...
def greedy_forward_selection(
    ...
    for step in range(max_factors):
        ...
        for name in remaining:
            alpha, t = _ols_alpha(candidate_arrays[name], base_matrix)
            result.all_candidates.append(SpanningResult(
                factor_name=name, alpha=alpha, t_stat=t, selected=False,
            ))
...
def _backward_eliminate(
    ...
    while changed:
        ...
        for name in list(selected_names):
            ...
            alpha, t = _ols_alpha(selected_arrays[name], base_matrix)
