...
Reliability: IC_IR, Hit_Rate, IC_Trend, Monotonicity.
...
from factorlib.tools.series import hit_rate, trend
...
def compute_profile(artifacts: Artifacts) -> FactorProfile:
    ...
    # --- Reliability ---
    ic_ir = ic.ic_ir(artifacts.ic_series, forward_periods=fp)
    ...
    reliability = [ic_ir, hit, ic_trend, mono]
