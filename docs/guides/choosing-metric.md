...
|---|---|---|---|
| Rank-ordering in a cross-section | [`ic`](../api/metrics/ic.md) | [`ic_ir`](../api/metrics/ic.md), [`monotonicity`](../api/metrics/monotonicity.md), [`k_spread`](../api/metrics/k_spread.md), [`directional_hit_rate`](../api/metrics/directional_hit_rate.md) | `ic` is the rank-based default for `Individual x Continuous`; diagnostics check concentration, spread shape, and sign skill. |
