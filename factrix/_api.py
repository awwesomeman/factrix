...
from factrix._types import UNSET, FactorType, coerce_factor_type
from factrix.preprocess.pipeline import PREPROCESS_SIG_MARKER, preprocess_sig
...
def _build_artifacts_strict(
    ...
    *,
    ...
    ``factrix.preprocess.pipeline.preprocess_sig`` for the authoritative
...
def evaluate(
    ...
    **config_overrides: Any,
    ...
    you'll pass here — factrix intentionally keeps preprocess and
...
def factor(
    ...
    **config_overrides: Any,
    ...
    """
    from factrix.factor import _FACTOR_REGISTRY
...
def redundancy_matrix(
    ...
    *,
    ...
    """See ``factrix.metrics.redundancy.redundancy_matrix``."""
    from factrix.metrics.redundancy import redundancy_matrix as _rm
