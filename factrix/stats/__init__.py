...
``multiple_testing`` — BHY false-discovery and Holm family-wise error-rate adjustments across a declared search family.
...
from factrix.stats.multiple_testing import bhy_adjust, bhy_adjusted_p, holm_adjusted_p
