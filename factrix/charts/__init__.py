"""factrix.charts — Plotly chart builders for factor analysis.

Requires: ``pip install factrix[charts]``
...
def report_charts(artifacts: Artifacts) -> dict[str, go.Figure]:
    ...
    from factrix.charts.ic import cumulative_ic_chart, ic_distribution_chart
    from factrix.charts.quantile import (
